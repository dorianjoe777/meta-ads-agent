...
function allowedActionCall(name){
 const actions={
  ...
  copyCommand,copyVisibleChatGptCode,skipWebsiteScan,setBusinessContextQuestionIndex,setMetaGuideSlide,setMetaGuideFrame,openMetaScreenshot,closeConfirm,skipOnboarding,closeUsageGuide,finishDashboardIntroTour,
