...
function directPublishingGuide(onboarding=false){
 ...
 const shots=lang==='es'?[
  ...
  ['4','Marca permisos de página','Usa pages_manage_posts y pages_read_engagement. Después pega aquí la clave.','meta-business-27-token-permissions-middle.png']
 ]:[
  ...
  ['4','Select Page permissions','Use pages_manage_posts and pages_read_engagement. Then paste the key here.','meta-business-27-token-permissions-middle.png']
 ];
