...
function allowedActionCall(name){
 const actions={
  ...
  copyCommand,copyVisibleChatGptCode,skipWebsiteScan,setBusinessContextQuestionIndex,setMetaGuideSlide,setMetaGuideFrame,openMetaScreenshot,skipOnboarding,closeUsageGuide,finishDashboardIntroTour,
