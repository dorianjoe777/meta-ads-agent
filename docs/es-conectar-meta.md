...
Admira debe conectarse a tu propia cuenta de Meta para leer datos reales y preparar acciones. Tienes dos caminos: una conexión estable recomendada, o una clave rápida para empezar antes.
...
3. Crea un Usuario del sistema para Admira.
...
9. Pega esa clave en el onboarding de Admira, en `Conectar mi cuenta de Facebook`.
...
Esta ruta puede funcionar bien para comenzar. La diferencia es que la clave puede vencer, así que Admira te avisará para renovarla aproximadamente cada 60 días. También podrás cambiar a la conexión estable más adelante desde `Configuración`.
