...
for secret_name in ingress_db_password runtime_db_password delivery_db_password scheduler_db_password provisioner_db_password image_db_password recovery_db_password email_delivery_db_password operator_db_password runtime_broker_key scheduler_broker_key recovery_hmac_key tenant_provisioner_key license_hosted_bridge_key; do
