...
# lifecycle validators there after applying 001-019.
if (( failures > 0 )); then
  exit 1
fi
printf '%s\n' 'Migration chain 007-019 passed read-only checks; no database was changed.'
