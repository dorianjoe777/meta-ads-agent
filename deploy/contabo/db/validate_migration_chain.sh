...
expected=(007_trial_provider_lifecycle.sql 008_central_image_jobs.sql 009_telegram_license_recovery.sql 010_operator_gemini_pool.sql 011_operator_dashboard.sql)
...
# existing validators there after applying 001-011.
if (( failures > 0 )); then
  exit 1
fi
printf '%s\n' 'Migration chain 007-011 passed read-only checks; no database was changed.'
