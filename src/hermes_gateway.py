...
def gateway_prompt(language="es", communication_style="simple", ad_experience_level=""):
    ...
    if str(language or "es").lower().startswith("en"):
        return (
            ...
            "or campaign names unless CURRENT_CONTEXT.json confirms real Meta data. Creating a full campaign/ad structure in PAUSED status may run after the buyer asks for it; "
    ...
    return (
        ...
        "perdedoras ni campañas si CURRENT_CONTEXT.json no confirma datos reales de Meta. Crear una estructura completa de campaña/anuncios en estado PAUSED puede ejecutarse después de que el comprador lo pida; "
