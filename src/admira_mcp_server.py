...
TOOL_INPUT_SCHEMAS = {
    ...
    "codex_image_generate": {
        ...
        "properties": {
            ...
            "visual_direction": _string("Natural-language visual direction agreed between buyer and agent, including composition, hierarchy, variation, and safe areas."),
            "text_content": {
                "type": "object",
                "additionalProperties": True,
                "description": "Structured text that Image 2 may place in the overlay.",
                "properties": {
