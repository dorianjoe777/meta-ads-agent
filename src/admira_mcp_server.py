...
TOOL_DEFINITIONS = [
    ...
    ("create_whatsapp_campaign", "Create a complete click-to-WhatsApp Meta campaign in PAUSED/no-spend state immediately after the buyer asks, without a second confirmation. This contract always uses the native WHATSAPP destination; never substitute wa.me website traffic. Supply the approved prefilled_message and creative. The backend resolves the live WhatsApp/Page identifiers. Success is returned only after Meta provides real campaign, ad-set, and ad IDs. Activation/spend remains separately approval-protected."),
    ("create_lead_form_campaign", "Create a complete native Meta Instant Form campaign in PAUSED/no-spend state immediately after the buyer asks, without a second confirmation. Supply a verified lead_gen_form_id returned by list_lead_forms/create_lead_form; no website URL is accepted or required. Success is returned only after Meta provides real campaign, ad-set, and ad IDs. Activation/spend remains separately approval-protected."),
    ("create_website_campaign", "Create a complete website-destination Meta campaign in PAUSED/no-spend state immediately after the buyer asks, without a second confirmation. A real final landing_url is mandatory. Do not use this contract for native WhatsApp, Messenger, Instagram Direct, lead-form, app, or on-Meta destinations. Success is returned only after Meta provides real campaign, ad-set, and ad IDs. Activation/spend remains separately approval-protected."),
    ("create_messaging_campaign", "Create a complete native Messenger or Instagram Direct campaign in PAUSED/no-spend state immediately after the buyer asks, without a second confirmation. message_destination must be MESSENGER or INSTAGRAM_DIRECT and welcome_message must contain the approved conversation opener. Success is returned only after Meta provides real campaign, ad-set, and ad IDs. Activation/spend remains separately approval-protected."),
    ("create_app_campaign", "Create a complete app-promotion Meta campaign in PAUSED/no-spend state immediately after the buyer asks, without a second confirmation. application_id and the exact App Store or Google Play object_store_url are mandatory. Success is returned only after Meta provides real campaign, ad-set, and ad IDs. Activation/spend remains separately approval-protected."),
    ("create_on_meta_campaign", "Create a complete awareness, video-view, engagement, or existing-Page-post campaign whose destination stays inside Meta, in PAUSED/no-spend state immediately after the buyer asks. Do not use it for websites, messaging, lead forms, or apps. Success is returned only after Meta provides real campaign, ad-set, and ad IDs. Activation/spend remains separately approval-protected."),
