    ...
    "codex_image_generate": {
        ...
        "properties": {
            ...
            "style_reference": {
                "type": "object",
                "additionalProperties": False,
                "description": "Saved graphic-design reference policy. Defaults to none; pool is set only by main-model semantic understanding, never keyword inference.",
                "properties": {
                    "mode": _string("Reference mode.", enum=("none", "pool", "explicit")),
