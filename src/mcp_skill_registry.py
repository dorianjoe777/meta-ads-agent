...
MCP_PRIMARY_SKILL = {
    ...
    "record_organic_content_proposal": "organic-content-strategy",
    "get_meta_history_context": "measurement-optimization",
    "capture_ad_library_reference": "creative-strategy",
    "search_content_assets": "brand-and-assets",
