...
class IntegrationTestSuite:
    ...
    def test_setup_page_contains_unlock_and_trust(self):
        ...
        self.assert_true("{id:'meta',status:tokenOk&&accountOk&&destinationOk&&publishingOk?'ok':'blocked'}" in html and "Token 1 · Anuncios" in html and "Token 2 · Página" in html, "The Meta activation section combines both tokens, account, Page, and website readiness")
