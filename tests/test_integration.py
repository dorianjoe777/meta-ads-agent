...
Perfecto. Ya entendí que tienes algo de experiencia con anuncios. Ahora cuéntame qué vende Singularity X Récords y cuál es su meta principal."""
    ...
    def test_release_package_excludes_runtime_data_and_includes_buyer_docs(self):
        ...
        self.assert_true("data-account-choice" in dashboard_js_source and "selectSocialAccountFromElement" in dashboard_js_source, "Meta account switch buttons keep their payload in a safe data attribute so changing a key cannot render an inert button")
