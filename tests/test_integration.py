...
class IntegrationTestSuite:
    ...
    def test_setup_page_contains_unlock_and_trust(self):
        ...
        self.assert_true("Abrir Facebook/Meta" in html and "Clave segura de Facebook/Meta" in html, "Spanish setup explains buyer-owned Facebook/Meta access plainly")
