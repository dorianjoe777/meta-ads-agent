...
class IntegrationTestSuite:
    ...
    def test_release_package_excludes_runtime_data_and_includes_buyer_docs(self):
        ...
        self.assert_true("META_ADS_AGENT_VERSION=v1.0.10" in env_example and (ROOT_DIR / "VERSION").read_text(encoding="utf-8").strip() == "v1.0.10", "Buyer release exposes the installed product version")
