...
class IntegrationTestSuite:
    ...
    def test_setup_page_contains_unlock_and_trust(self):
        ...
        self.assert_true("Abrir Meta Business" in html and "Clave estable de Facebook/Meta" in html, "Spanish setup explains buyer-owned stable Meta Business access plainly")
        self.assert_true("Recomendado: conexión estable" in html and "Prueba rápida: token temporal" in html and "Graph API Explorer puede vencer" in html, "Meta onboarding prioritizes stable System User tokens and demotes Graph API Explorer to testing")
