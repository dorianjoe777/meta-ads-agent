...
class IntegrationTestSuite:
    ...
    def test_brand_memory_documents_feed_creative_generation(self):
        ...
        try:
            ...
            self.assert_true(logo_upload["library"]["general"]["fields"]["logo_path"] == "brand_guides/assets/luz-clara-logo.png", "Dashboard logo upload keeps the saved official logo selected for future creatives")
