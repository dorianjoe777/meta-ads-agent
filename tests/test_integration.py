...
class IntegrationTestSuite:
    ...
    def test_release_package_excludes_runtime_data_and_includes_buyer_docs(self):
        ...
        self.assert_true("if(!data.valid){\n          if(pendingWindow) pendingWindow.close();" in portal_page and "if(data.status === 'digitalocean_token_required') focusDigitalOceanToken();" in portal_page, "Cloud dashboard opener shows portal refresh errors instead of hiding them behind the Droplet access gate")
