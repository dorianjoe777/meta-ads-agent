...
class IntegrationTestSuite:
    ...
    def test_release_package_excludes_runtime_data_and_includes_buyer_docs(self):
        ...
        self.assert_true("data-cloud-open-url" in portal_page and "openCloudDashboard" in portal_page and "action: 'refresh_access'" in portal_page and "data.cloud_open_url || fallbackUrl || data.dashboard_url" in portal_page, "Cloud dashboard opener refreshes access through the portal but opens the resilient access gate first")
        ...
        self.assert_true("esta activo, pero no tiene permiso para modificar el firewall" in portal_digitalocean_api and "permiso de escritura para Firewalls y Droplets" in portal_digitalocean_api, "DigitalOcean 403 firewall errors explain permission scope instead of saying the token is invalid")
        self.assert_true("esta activo, pero no tiene permiso para borrar este servidor" in portal_digitalocean_api, "DigitalOcean 403 delete errors explain missing Droplet write permission")
