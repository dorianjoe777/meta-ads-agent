...
class IntegrationTestSuite:
    ...
    def test_release_package_excludes_runtime_data_and_includes_buyer_docs(self):
        ...
        self.assert_true("CLOUD_DASHBOARD_BASE_DOMAIN" in portal_digitalocean_api and "CLOUDFLARE_API_TOKEN" in portal_digitalocean_api and "dns_records" in portal_digitalocean_api, "DigitalOcean cloud install can create per-install DNS records for HTTPS dashboards")
