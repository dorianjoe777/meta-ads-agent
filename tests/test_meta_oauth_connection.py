...
class MetaOAuthConnectionTests(unittest.TestCase):
    ...
    def test_empty_business_profile_requires_strategic_onboarding(self):
        ...
        self.assertIn("begin the business onboarding as a required product stage", skill)
        self.assertIn("The onboarding summary describes the business; it is not the strategic plan", skill)
