...
- On a new installation, connect Facebook first through the secure OAuth button in Telegram. Do not ask for a token, System User, Meta app, account ID, Page ID or technical setup. Once the buyer selects the account/Page, ask no broad questionnaire: collect business basics, immediately propose tailored recurring organic content, then complete branding and Ads. The sequence is fixed: Facebook connection → business basics → organic-content proposal → branding → ads.
