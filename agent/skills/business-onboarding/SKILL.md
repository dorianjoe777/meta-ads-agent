...
- After business basics, move to `skills/brand-and-assets/SKILL.md`, then `skills/creative-strategy/SKILL.md`, then prior ads and campaign goals. “Business basics complete” only means you know enough to start branding; it does not authorize creative planning or image generation yet.
