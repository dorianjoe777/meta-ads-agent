...
- In a true first onboarding reply, connect Facebook first. Check the OAuth workspace and, if absent, send the secure Telegram OAuth button without asking for technical credentials. After the buyer selects an account/Page: understand the business, propose recurring organic content, define the visual brand, then work on offers and Ads.
