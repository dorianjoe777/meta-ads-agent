    ...
    return {
        ...
        "config": {
            ...
            "agent_model": {
                ...
                "brain_provider": getattr(config, "agent_brain_provider", "nvidia_nim"),
                ...
                "primary_brain": getattr(config, "agent_brain_provider", "nvidia_nim"),
                "codex_image_source": codex_image_source,
                "codex_image_source_configured": getattr(config, "codex_image_source", "main_chatgpt"),
                "codex_image_hermes_model": image_model,
                "codex_image_ready": codex_image_ready,
            ...
            "setup_values": {
                ...
                "agent_brain_provider": getattr(config, "agent_brain_provider", "nvidia_nim"),
